...
const demoExpenses: ExpenseRecord[] = [
  ...
  { id: '3', date: '2026-04-08', propertyName: 'Mykonos Beach House', propertyId: 'p3', category: 'UTILITIES', description: 'Electricity bill - March 2026', vendor: 'HEDNO S.A.', amount: 320, approvalStatus: 'APPROVED' },
  { id: '4', date: '2026-04-07', propertyName: 'Crete Harbor Suite', propertyId: 'p4', category: 'SUPPLIES', description: 'Linens and towels replacement', vendor: 'Hospitality Supply GR', amount: 450, approvalStatus: 'PENDING' },
  { id: '5', date: '2026-04-06', propertyName: 'Santorini Sunset Villa', propertyId: 'p1', category: 'INSURANCE', description: 'Annual property insurance premium', vendor: 'Ethniki Insurance', amount: 1200, approvalStatus: 'APPROVED' },
  ...
  { id: '8', date: '2026-04-03', propertyName: 'Mykonos Beach House', propertyId: 'p3', category: 'MAINTENANCE', description: 'Pool pump replacement', vendor: 'Pool Masters GR', amount: 780, approvalStatus: 'PENDING' },
  ...
  { id: '10', date: '2026-04-01', propertyName: 'Santorini Sunset Villa', propertyId: 'p1', category: 'TAXES', description: 'Property tax Q1 2026', vendor: 'Hellenic Tax Authority', amount: 520, approvalStatus: 'APPROVED' },
...
export default function ExpenseListPage() {
  ...
  const handleApprove = (id: string) => {
    setExpenses((prev) =>
      prev.map((e) => (e.id === id ? { ...e, approvalStatus: 'APPROVED' as ApprovalStatus } : e)),
    );
            ...
            <tbody>
              {paginated.map((rec) => (
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    <span
                      className={`px-2.5 py-1 rounded-full text-[10px] font-semibold uppercase tracking-wider ${approvalStatusStyles[rec.approvalStatus]}`}
                    >
